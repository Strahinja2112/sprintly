namespace Sprintra.Forms {
  partial class MainForm {
    ...
    private void InitializeComponent() {
      ...
      LabelWorkTasks.Font = new Font("Segoe UI Semibold", 13.5F);
      LabelWorkTasks.ForeColor = Color.FromArgb(65, 65, 65);
      LabelWorkTasks.Location = new Point(40, 0);
      LabelWorkTasks.Name = "LabelWorkTasks";
      LabelWorkTasks.Size = new Size(150, 50);
      ...
      LabelUserStories.Font = new Font("Segoe UI Semibold", 13.5F);
      LabelUserStories.ForeColor = Color.FromArgb(65, 65, 65);
      LabelUserStories.Location = new Point(40, 0);
      LabelUserStories.Name = "LabelUserStories";
      LabelUserStories.Size = new Size(150, 50);
      LabelUserStories.TabIndex = 6;
      LabelUserStories.Text = "Korisničke Priče";
      ...
      LabelEmployees.Font = new Font("Segoe UI Semibold", 13.5F);
      LabelEmployees.ForeColor = Color.FromArgb(65, 65, 65);
      LabelEmployees.Location = new Point(40, 0);
      LabelEmployees.Name = "LabelEmployees";
      LabelEmployees.Size = new Size(150, 50);
      ...
      LabelWorkLog.Font = new Font("Segoe UI Semibold", 13.5F);
      LabelWorkLog.ForeColor = Color.FromArgb(65, 65, 65);
      LabelWorkLog.Location = new Point(40, 0);
      ...
      LabelProjects.Font = new Font("Segoe UI Semibold", 13.5F);
      LabelProjects.ForeColor = Color.FromArgb(65, 65, 65);
      LabelProjects.Location = new Point(40, 0);
      LabelProjects.Name = "LabelProjects";
      LabelProjects.Size = new Size(150, 50);
      ...
      LabelSprints.Font = new Font("Segoe UI Semibold", 13.5F);
      LabelSprints.ForeColor = Color.FromArgb(65, 65, 65);
      LabelSprints.Location = new Point(40, 0);
      LabelSprints.Name = "LabelSprints";
      LabelSprints.Size = new Size(150, 50);
      ...
      LabelSprintsCount.Location = new Point(0, 92);
      LabelSprintsCount.Name = "LabelSprintsCount";
      LabelSprintsCount.Size = new Size(150, 58);
      ...
      dungeonLabel7.Location = new Point(0, 66);
      ...
      LabelEmployeesCount.Location = new Point(0, 92);
      LabelEmployeesCount.Name = "LabelEmployeesCount";
      LabelEmployeesCount.Size = new Size(150, 58);
      ...
      dungeonLabel5.Location = new Point(0, 66);
      ...
      LabelProjectsCount.Location = new Point(0, 92);
      LabelProjectsCount.Name = "LabelProjectsCount";
      LabelProjectsCount.Size = new Size(150, 58);
      ...
      dungeonLabel2.Location = new Point(0, 66);
